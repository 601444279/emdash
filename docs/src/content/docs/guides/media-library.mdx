...
4. Move the crop frame over the image, then drag any edge or corner to resize it. The eight handles
   and rule-of-thirds grid remain visible. You can also focus the frame or a handle and use the
