...
<Aside>
	This Dockerfile builds **your own EmDash site**, which is a project that has `emdash` as a dependency. It is
...
below pin them to a value you control, which is useful when a separate
