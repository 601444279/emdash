...
export function SocialSettings() {
		...
		return (
			<div className="space-y-6">
				<div className="flex items-center gap-3">
					<BackToSettingsLink />
					<h1 className="text-2xl font-semibold leading-tight tracking-tight">{t`Social Links`}</h1>
				</div>
	...
	return (
		<div className="space-y-6">
			...
			>
				<h1 className="truncate text-2xl font-semibold leading-tight tracking-tight">{t`Social Links`}</h1>
			</EditorHeader>
