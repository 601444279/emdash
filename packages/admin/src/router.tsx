		...
		return (
			<div className="flex items-center justify-center min-h-[50vh]">
				<div className="text-center">
					<h1 className="text-2xl font-semibold leading-tight tracking-tight">{t`Access Denied`}</h1>
...
function ErrorScreen({ error }: { error: string }) {
	...
	return (
		<div className="flex items-center justify-center min-h-screen">
			<div className="text-center">
				<h1 className="text-2xl font-semibold leading-tight tracking-tight text-kumo-danger">{t`Error`}</h1>
...
function NotFoundPage({ message }: { message?: string }) {
	...
	return (
		<div className="flex items-center justify-center min-h-[50vh]">
			<div className="text-center">
				<h1 className="text-2xl font-semibold leading-tight tracking-tight">{t`Page Not Found`}</h1>
